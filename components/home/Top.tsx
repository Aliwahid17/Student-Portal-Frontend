            ...
            <div className="container pr-3 pl-3  ">
                <div className='pr-2 pl-2 lg:pr-0 lg-pl-0 flex flex-wrap items-center lg:flex-row-reverse flex-col '>
                    ...
                    <div className='flex flex-2auto flex-col w-full lg:w-1/2'>
                        ...
                        <Link href='#price' ><a className="text-white w-fit lg:ml-9 text-base md:text-xl font-semibold border px-4 py-2 rounded-lg bg-gradient-to-r from-red-500 to-red-800 hover:from-sky-400 hover:to-cyan-500">Join Student Hub <HiOutlineArrowNarrowRight className='inline-flex mb-[2px]' /></a></Link>
                    </div>
                    {/* <div className='flex flex-2auto flex-col w-full lg:w-1/2'>
                        <h1 className="text-black text-[36px] md:text-5xl lg:text-6xl mb-4 lg:pl-9 font-bold leading-none">
                            <span className="text-red-600">Student-Hub</span> is a place for Students.
                        </h1>
                        <p className="text-lg text-black mb-4 lg:pl-9">Learn from expert professionals and<br /> join
