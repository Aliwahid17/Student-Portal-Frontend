            ...
            <div className="max-w-md mx-auto mb-14 text-center">
                ...
                <div className="flex flex-col text-center w-full mb-20">
                    <div className="flex mx-auto border-2 border-blue-500 rounded overflow-hidden mt-6">
                        <button onClick={() => setPricing(false)} className={`py-1 px-4 focus:outline-none ${pricing ? "" : "bg-blue-500 text-white"}`}>Monthly</button>
                        <button onClick={() => setPricing(true)} className={`py-1 px-4 focus:outline-none ${!pricing ? "" : "bg-blue-500 text-white"}`}>Annually</button>
                    </div>
                </div>
            </div>
